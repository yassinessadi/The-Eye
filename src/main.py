    ...
    def run(self):
        ...
        for query in queries_list:
            if choice == '1':
                ...
                source_page = get_elements.GetElements.get_page_source(driver)
                search_results = get_elements.GetElements.extract_elements(source_page, 'google')
            elif choice == '2':
                ...
                get_elements.GetElements.scroll_page(driver)
                source_page = get_elements.GetElements.get_page_source(driver)
                search_results = get_elements.GetElements.extract_elements(source_page, 'yandex')
            else:
